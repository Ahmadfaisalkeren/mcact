...
import HeaderMcact from '@/components/HeaderMcact.vue';
import FooterMcact from '@/components/FooterMcact.vue';
import RelatedMcact from '@/components/RelatedMcact.vue';
